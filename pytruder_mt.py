...
def run(args: tuple):
    ...
    return [(response_number, payload_text, status_code, response_time, response_length, index), response]
...
def main():
    ...
    while True: 
        choice = input("Enter 1 to view a response, 2 to save a response, 3 to view response in browser, or 4 to exit and press ENTER: ")
        match choice: 
            case "1": 
